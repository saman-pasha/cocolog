...
tr_cross_connector(_, M, M) :- atom(M), memberchk(M, [semicolon, colon, endquote, dash, dashes, reported]), !.
...
tr_meanings_of(L, To, Class, Ms) :-
    ...
    ;   To == english, From == foreign, memberchk(Class, [noun, adjective, adverb]),
