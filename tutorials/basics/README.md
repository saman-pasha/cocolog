...
| 09-exceptions | failure is not an error; `catch/3`, `throw/1`, ISO error terms — and the four that are cocolog's: `cocolog_error/1`, an unbound context that matches anyway, cleanup by hand, a ball whose text is codes |
