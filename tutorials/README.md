...
| [`library/`](library/) | twenty-nine lessons, one per library that ships | `COCOLOG_LIBRARY=$PWD/library ./cocolog run tutorials/library/01-lists.pl main` |
...
nobody has demonstrated end to end, and the twenty-nine that are there
